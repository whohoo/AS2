...
/************************************************************************
 * change some method for SimplePaper.
 * support smoothing
 * @author wally
 * 
 * 
...
class com.wlash.as3d.DistortImage extends Object {
	...
	*/
	public function initialize(vseg: Number, hseg: Number ):Void{
		if( target instanceof BitmapData ){
			texture = BitmapData(target);
		}else if( target instanceof MovieClip ){
			texture = new BitmapData( target._width, target._height );
			texture.draw( target );
		}else{
	...
	*/
	...
	private function __render( ): Void	{
		...
		var c:MovieClip = _container; c.clear();
		var a:Array;
		var sM = {};
		var tM = {};
		//--
